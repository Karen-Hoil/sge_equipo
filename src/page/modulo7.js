    ...
    <div className="flex flex-col min-h-screen bg-gray-100">
      <header>
        <nav className="flex justify-between items-center bg-blue-800 text-white p-4">
          <div>
            <img src={logo} alt="logo-ut" className="h-12" />
          </div>
          <ul className="flex space-x-4">
            <li><a href="#gestion" className="hover:text-gray-300">Gestión de estadias</a></li>
            <li><a href="#proyecto" className="hover:text-gray-300">Proyecto</a></li>
            <li><a href="#calendario" className="hover:text-gray-300">Calendario</a></li>
            <li><a href="#documentos" className="hover:text-gray-300">Documentos</a></li>
          </ul>
          <div>
